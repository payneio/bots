...
async def test_full_system():
    ...
    try:
        ...
        messages = [
            Message(role=MessageRole.SYSTEM, content="You are a helpful CLI assistant that can suggest commands."),
            Message(role=MessageRole.USER, content="How do I list all files in the current directory?")
        ]
