...
async def test_command_tool():
    ...
    try:
        ...
        messages = [
            Message(role=MessageRole.SYSTEM, content="You are a helpful CLI assistant that can execute commands."),
        ...
        messages = [
            Message(role=MessageRole.SYSTEM, content="You are a helpful CLI assistant that can execute commands."),
            Message(role=MessageRole.USER, content="Find all Python files in the bot directory and count how many imports they have.")
        ]
