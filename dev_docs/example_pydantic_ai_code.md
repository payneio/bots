# Example PydanticAI code

The following examples were taken from PydanticAI's most recent release's documentation at https://ai.pydantic.dev/.

## Pydantic model

Simple example of using PydanticAI to construct a Pydantic model from a text input. Demonstrates: structured output_type
